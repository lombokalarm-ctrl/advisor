...
```mermaid
flowchart TD
    A["Pengguna menemukan halaman dari Google"] --> B["Membuka beranda, landing page, artikel, atau halaman layanan"]
    B --> C["Membaca informasi dan melihat CTA"]
    C --> D["Menjelajahi paket, destinasi, armada, atau artikel terkait"]
    D --> E["Masuk ke money page yang paling relevan"]
    E --> F["Klik WhatsApp untuk konsultasi atau booking"]
    F --> G["Admin memproses lead secara manual"]
```
